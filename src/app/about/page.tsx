    ...
    <div className="pt-24 lg:pt-32 pb-24 overflow-hidden">
      ...
      <div className="px-6 lg:px-12 max-w-350 mx-auto mb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            <p className="text-[0.65rem] tracking-[0.3em] uppercase text-rose-main mb-4">
              La maison ROSÉ
            </p>
            <SplitTitle as="h1" className="text-[clamp(2.5rem,5vw,4.5rem)] text-ink">
              Une vision de l&apos;élégance au féminin
            </SplitTitle>
            <p className="mt-6 text-ink-soft text-sm leading-relaxed max-w-md">
      ...
      {/* Values section */}
      <div className="bg-rose-blush py-20 px-6 lg:px-12">
        <div className="max-w-350 mx-auto">
          <SplitTitle as="h2" className="text-[clamp(2rem,4vw,3rem)] text-ink mb-16 text-center">
            Nos engagements
          </SplitTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div key={item.number} className="flex flex-col gap-4">
                <span className="font-serif text-5xl font-light text-rose-soft">
                  {item.number}
                </span>
