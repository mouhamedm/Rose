...
export default function FavoritesPage() {
  ...
  return (
    <div className="pt-32 lg:pt-40 pb-24 px-6 lg:px-12 max-w-[1400px] mx-auto min-h-screen">
      <div className="mb-12">
      ...
      {favoriteProducts.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-32 gap-6 text-center">
          <Heart size={40} strokeWidth={1} className="text-[var(--color-rose-soft)]" />
          <p className="font-serif text-2xl font-light text-[var(--color-ink-soft)]">
            Aucun favori pour l&apos;instant
          </p>
          <p className="text-sm text-[var(--color-ink-soft)]/60 max-w-xs">
